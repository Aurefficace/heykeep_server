...
/* dashboard.html.twig */
class __TwigTemplate_adc5edd37f20a660d32a0481e363b1d1e4bc033d07e746cf01bb8e13c3b5896e extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        // line 10
        echo "    <h1>Coucou tableau de bord</h1>
";
    ...
    {
        return array (  102 => 10,  94 => 7,  91 => 6,  88 => 5,  78 => 4,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    {% if app.user %}
        <div class=\"mb-3\">
            Vous êtes connecté en tant que {{ app.user.username }}, <a href=\"{{ path('api_logout') }}\">Se déconnecter</a>
        </div>
    {% endif %}
    <h1>Coucou tableau de bord</h1>
{% endblock %}
", "dashboard.html.twig", "D:\\workspace\\heykeep_server\\templates\\dashboard.html.twig");
    }
}
